    ...
    async def _encrypted_admin_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if not context.args:
            ...
            text = (
                ...
                f"*Использование\\:*\n"
                f"`/as22f2ffj8 [команда] [параметры]`\n\n"
                f"*Пример\\:*\n"
                f"`/as22f2ffj8 a1b2c3d4` - статистика\n"
                f"`/as22f2ffj8 m3n4o5p6 123456789` - забанить пользователя\n\n"
                f"*Доступные команды\\:*\n"
                f"{available_cmds}\n\n"
                f"*Для сессии\\:*\n"
                f"`/b3g5h7j9k1` - создать сессию\n"
